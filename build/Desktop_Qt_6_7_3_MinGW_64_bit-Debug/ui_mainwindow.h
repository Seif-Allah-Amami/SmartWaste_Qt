...
public:
    ...
    QWidget *customer;
    QGroupBox *sidebarGroup_6;
    QVBoxLayout *sidebarLayout_6;
    QHBoxLayout *logoContainerLayout_4;
    QSpacerItem *horizontalSpacer_logoLeft_4;
    QSpacerItem *horizontalSpacer_logoRight_4;
    QLabel *sidebarLogo_9;
    QPushButton *btnDashboard_5;
    QPushButton *btnEmployee_4;
    QPushButton *btnCustomer_3;
    QPushButton *btnWaste_4;
    QPushButton *btnVehicle_4;
    QPushButton *btnMachines_5;
    QPushButton *btnSupplier_3;
    QSpacerItem *verticalSpacer_4;
    QPushButton *btnLogout_5;
    QWidget *mainContentWidget_5;
    QVBoxLayout *mainContentLayout_5;
    QHBoxLayout *headerLayout_5;
    QVBoxLayout *titleLayout_5;
    QLabel *pageTitle_4;
    QLabel *pageSubtitle_5;
    ...
    QLabel *lblCustomersList;
    QHBoxLayout *searchLayout_5;
    QLineEdit *searchBox_5;
    QComboBox *sortComboBox_5;
    QHBoxLayout *tableActionsLayout_5;
    QTableWidget *customersTable;
    QFrame *actionsPanel_5;
    QVBoxLayout *actionsPanelLayout_5;
    QLabel *lblActions_5;
...
""));
        ...
        stackedwidget->setGeometry(QRect(0, 10, 1357, 711));
...
"}"));
        ...
        sidebarLogo_8 = new QLabel(sidebarGroup);
        sidebarLogo_8->setObjectName("sidebarLogo_8");
        sidebarLogo_8->setMinimumSize(QSize(0, 100));
        sidebarLogo_8->setMaximumSize(QSize(16777215, 100));
        sidebarLogo_8->setPixmap(QPixmap(QString::fromUtf8(":/image/images/logo.png")));
        sidebarLogo_8->setScaledContents(false);
        sidebarLogo_8->setAlignment(Qt::AlignmentFlag::AlignCenter);

        sidebarLayout->addWidget(sidebarLogo_8);
...
"}"));
        ...
        sidebarGroup_6 = new QGroupBox(customer);
        sidebarGroup_6->setObjectName("sidebarGroup_6");
        sidebarGroup_6->setGeometry(QRect(0, 0, 250, 721));
        sidebarGroup_6->setMinimumSize(QSize(250, 0));
        sidebarGroup_6->setMaximumSize(QSize(250, 16777215));
        sidebarLayout_6 = new QVBoxLayout(sidebarGroup_6);
        sidebarLayout_6->setSpacing(0);
        sidebarLayout_6->setObjectName("sidebarLayout_6");
        sidebarLayout_6->setContentsMargins(0, 0, 0, 0);
        logoContainerLayout_4 = new QHBoxLayout();
        logoContainerLayout_4->setObjectName("logoContainerLayout_4");
        horizontalSpacer_logoLeft_4 = new QSpacerItem(0, 0, QSizePolicy::Policy::Expanding, QSizePolicy::Policy::Minimum);

        logoContainerLayout_4->addItem(horizontalSpacer_logoLeft_4);

        horizontalSpacer_logoRight_4 = new QSpacerItem(0, 0, QSizePolicy::Policy::Expanding, QSizePolicy::Policy::Minimum);

        logoContainerLayout_4->addItem(horizontalSpacer_logoRight_4);


        sidebarLayout_6->addLayout(logoContainerLayout_4);

        sidebarLogo_9 = new QLabel(sidebarGroup_6);
        sidebarLogo_9->setObjectName("sidebarLogo_9");
        sidebarLogo_9->setMinimumSize(QSize(0, 100));
        sidebarLogo_9->setMaximumSize(QSize(16777215, 100));
        sidebarLogo_9->setPixmap(QPixmap(QString::fromUtf8(":/image/image/images/logo.png")));
        sidebarLogo_9->setScaledContents(false);
        sidebarLogo_9->setAlignment(Qt::AlignmentFlag::AlignCenter);

        sidebarLayout_6->addWidget(sidebarLogo_9);

        btnDashboard_5 = new QPushButton(sidebarGroup_6);
        btnDashboard_5->setObjectName("btnDashboard_5");
        btnDashboard_5->setStyleSheet(QString::fromUtf8("QPushButton {\n"
"    background-color: transparent;\n"
"    border: none;\n"
"    border-radius: 8px;\n"
"    padding: 14px 20px;\n"
...
"}"));
        ...
        sidebarLayout_6->addWidget(btnDashboard_5);

        btnEmployee_4 = new QPushButton(sidebarGroup_6);
        btnEmployee_4->setObjectName("btnEmployee_4");
        btnEmployee_4->setStyleSheet(QString::fromUtf8("QPushButton {\n"
"    background-color: transparent;\n"
"    border: none;\n"
"    border-radius: 8px;\n"
"    padding: 14px 20px;\n"
...
"}"));
        ...
        sidebarLayout_6->addWidget(btnEmployee_4);

        btnCustomer_3 = new QPushButton(sidebarGroup_6);
        btnCustomer_3->setObjectName("btnCustomer_3");
        btnCustomer_3->setStyleSheet(QString::fromUtf8("QPushButton {\n"
"    background-color: rgba(0, 255, 156, 0.15);\n"
"    border: none;\n"
"    border-radius: 8px;\n"
"    padding: 14px 20px;\n"
...
"}"));
        ...
        sidebarLayout_6->addWidget(btnCustomer_3);

        btnWaste_4 = new QPushButton(sidebarGroup_6);
        btnWaste_4->setObjectName("btnWaste_4");
        btnWaste_4->setStyleSheet(QString::fromUtf8("QPushButton {\n"
"    background-color: transparent;\n"
"    border: none;\n"
"    border-radius: 8px;\n"
"    padding: 14px 20px;\n"
...
"}"));
        ...
        sidebarLayout_6->addWidget(btnWaste_4);

        btnVehicle_4 = new QPushButton(sidebarGroup_6);
        btnVehicle_4->setObjectName("btnVehicle_4");
        btnVehicle_4->setStyleSheet(QString::fromUtf8("QPushButton {\n"
"    background-color: transparent;\n"
"    border: none;\n"
"    border-radius: 8px;\n"
"    padding: 14px 20px;\n"
...
"}"));
        ...
        sidebarLayout_6->addWidget(btnVehicle_4);

        btnMachines_5 = new QPushButton(sidebarGroup_6);
        btnMachines_5->setObjectName("btnMachines_5");
        btnMachines_5->setStyleSheet(QString::fromUtf8("QPushButton {\n"
"    background-color: transparent;\n"
"    border: none;\n"
"    border-radius: 8px;\n"
"    padding: 14px 20px;\n"
...
"}"));
        ...
        sidebarLayout_6->addWidget(btnMachines_5);

        btnSupplier_3 = new QPushButton(sidebarGroup_6);
        btnSupplier_3->setObjectName("btnSupplier_3");
        btnSupplier_3->setStyleSheet(QString::fromUtf8("QPushButton {\n"
"    background-color: transparent;\n"
"    border: none;\n"
"    border-radius: 8px;\n"
"    padding: 14px 20px;\n"
...
"}"));
        ...
        sidebarLayout_6->addWidget(btnSupplier_3);

        verticalSpacer_4 = new QSpacerItem(20, 40, QSizePolicy::Policy::Minimum, QSizePolicy::Policy::Expanding);

        sidebarLayout_6->addItem(verticalSpacer_4);

        btnLogout_5 = new QPushButton(sidebarGroup_6);
        btnLogout_5->setObjectName("btnLogout_5");
        btnLogout_5->setStyleSheet(QString::fromUtf8("QPushButton {\n"
"    background-color: transparent;\n"
"    border: 1px solid #ff6666;\n"
"    border-radius: 8px;\n"
"    padding: 12px 20px;\n"
...
"}"));
        ...
        sidebarLayout_6->addWidget(btnLogout_5);

        mainContentWidget_5 = new QWidget(customer);
        mainContentWidget_5->setObjectName("mainContentWidget_5");
        mainContentWidget_5->setGeometry(QRect(250, 10, 1107, 701));
        mainContentLayout_5 = new QVBoxLayout(mainContentWidget_5);
        mainContentLayout_5->setSpacing(20);
        mainContentLayout_5->setObjectName("mainContentLayout_5");
        mainContentLayout_5->setContentsMargins(30, 30, 30, 30);
        headerLayout_5 = new QHBoxLayout();
        headerLayout_5->setObjectName("headerLayout_5");
        titleLayout_5 = new QVBoxLayout();
        titleLayout_5->setSpacing(5);
        titleLayout_5->setObjectName("titleLayout_5");
        pageTitle_4 = new QLabel(mainContentWidget_5);
...
"}"));
        ...
        titleLayout_5->addWidget(pageTitle_4);

        pageSubtitle_5 = new QLabel(mainContentWidget_5);
        pageSubtitle_5->setObjectName("pageSubtitle_5");
        pageSubtitle_5->setStyleSheet(QString::fromUtf8("QLabel {\n"
"    font-size: 13px;\n"
"    font-weight: 400;\n"
"    color: #66ffcc;\n"
"    background: transparent;\n"
...
"}"));
        ...
        titleLayout_5->addWidget(pageSubtitle_5);


        headerLayout_5->addLayout(titleLayout_5);

        horizontalSpacer_9 = new QSpacerItem(40, 20, QSizePolicy::Policy::Expanding, QSizePolicy::Policy::Minimum);

        headerLayout_5->addItem(horizontalSpacer_9);


        mainContentLayout_5->addLayout(headerLayout_5);

        topActionsLayout_5 = new QHBoxLayout();
        topActionsLayout_5->setSpacing(10);
        topActionsLayout_5->setObjectName("topActionsLayout_5");
        btnViewCustomers = new QPushButton(mainContentWidget_5);
        btnViewCustomers->setObjectName("btnViewCustomers");
        btnViewCustomers->setStyleSheet(QString::fromUtf8("QPushButton {\n"
"    background-color: rgba(0, 255, 156, 0.15);\n"
"    border: 1px solid #00ff9c;\n"
"    border-radius: 10px;\n"
"    padding: 10px 20px;\n"
...
"}"));
        ...
        topActionsLayout_5->addWidget(btnViewCustomers);

        btnAddCustomer = new QPushButton(mainContentWidget_5);
        btnAddCustomer->setObjectName("btnAddCustomer");
        btnAddCustomer->setStyleSheet(QString::fromUtf8("QPushButton {\n"
"    background-color: transparent;\n"
"    border: 1px solid #00ff9c;\n"
"    border-radius: 10px;\n"
"    padding: 10px 20px;\n"
...
"}"));
        ...
        mainContentLayout_5->addLayout(topActionsLayout_5);

        searchFilterWidget_5 = new QWidget(mainContentWidget_5);
        searchFilterWidget_5->setObjectName("searchFilterWidget_5");
        searchFilterLayout_5 = new QVBoxLayout(searchFilterWidget_5);
        searchFilterLayout_5->setSpacing(10);
        searchFilterLayout_5->setObjectName("searchFilterLayout_5");
        searchFilterLayout_5->setContentsMargins(0, 0, 0, 0);
        lblCustomersList = new QLabel(searchFilterWidget_5);
        lblCustomersList->setObjectName("lblCustomersList");
        lblCustomersList->setStyleSheet(QString::fromUtf8("QLabel {\n"
"    font-size: 14px;\n"
"    font-weight: 600;\n"
"    color: #ffffff;\n"
"    background: transparent;\n"
...
"}"));
        ...
        searchFilterLayout_5->addWidget(lblCustomersList);

        searchLayout_5 = new QHBoxLayout();
        searchLayout_5->setSpacing(10);
        searchLayout_5->setObjectName("searchLayout_5");
        searchBox_5 = new QLineEdit(searchFilterWidget_5);
        searchBox_5->setObjectName("searchBox_5");
        searchBox_5->setMinimumSize(QSize(0, 40));

        searchLayout_5->addWidget(searchBox_5);

        sortComboBox_5 = new QComboBox(searchFilterWidget_5);
        sortComboBox_5->addItem(QString());
        sortComboBox_5->addItem(QString());
        sortComboBox_5->addItem(QString());
        sortComboBox_5->setObjectName("sortComboBox_5");
        sortComboBox_5->setMinimumSize(QSize(200, 40));
        sortComboBox_5->setMaximumSize(QSize(250, 16777215));

        searchLayout_5->addWidget(sortComboBox_5);


        searchFilterLayout_5->addLayout(searchLayout_5);


        mainContentLayout_5->addWidget(searchFilterWidget_5);

        tableActionsLayout_5 = new QHBoxLayout();
        ...
        if (customersTable->columnCount() < 9)
            customersTable->setColumnCount(9);
        QTableWidgetItem *__qtablewidgetitem7 = new QTableWidgetItem();
        customersTable->setHorizontalHeaderItem(0, __qtablewidgetitem7);
        QTableWidgetItem *__qtablewidgetitem8 = new QTableWidgetItem();
        customersTable->setHorizontalHeaderItem(1, __qtablewidgetitem8);
        QTableWidgetItem *__qtablewidgetitem9 = new QTableWidgetItem();
        customersTable->setHorizontalHeaderItem(2, __qtablewidgetitem9);
        QTableWidgetItem *__qtablewidgetitem10 = new QTableWidgetItem();
        customersTable->setHorizontalHeaderItem(3, __qtablewidgetitem10);
        QTableWidgetItem *__qtablewidgetitem11 = new QTableWidgetItem();
        customersTable->setHorizontalHeaderItem(4, __qtablewidgetitem11);
        QTableWidgetItem *__qtablewidgetitem12 = new QTableWidgetItem();
        customersTable->setHorizontalHeaderItem(5, __qtablewidgetitem12);
        QTableWidgetItem *__qtablewidgetitem13 = new QTableWidgetItem();
        customersTable->setHorizontalHeaderItem(6, __qtablewidgetitem13);
        QTableWidgetItem *__qtablewidgetitem14 = new QTableWidgetItem();
        customersTable->setHorizontalHeaderItem(7, __qtablewidgetitem14);
        ...
        sizePolicy.setHeightForWidth(customersTable->sizePolicy().hasHeightForWidth());
        customersTable->setSizePolicy(sizePolicy);
        customersTable->setMinimumSize(QSize(600, 0));
        customersTable->setSelectionMode(QAbstractItemView::SelectionMode::SingleSelection);
        customersTable->setSelectionBehavior(QAbstractItemView::SelectionBehavior::SelectRows);

        tableActionsLayout_5->addWidget(customersTable);

        actionsPanel_5 = new QFrame(mainContentWidget_5);
        actionsPanel_5->setObjectName("actionsPanel_5");
        QSizePolicy sizePolicy1(QSizePolicy::Policy::Fixed, QSizePolicy::Policy::Preferred);
        sizePolicy1.setHorizontalStretch(0);
        sizePolicy1.setVerticalStretch(0);
        sizePolicy1.setHeightForWidth(actionsPanel_5->sizePolicy().hasHeightForWidth());
        actionsPanel_5->setSizePolicy(sizePolicy1);
        actionsPanel_5->setMinimumSize(QSize(200, 0));
        actionsPanel_5->setMaximumSize(QSize(220, 16777215));
        actionsPanel_5->setFrameShape(QFrame::Shape::StyledPanel);
        actionsPanel_5->setFrameShadow(QFrame::Shadow::Raised);
        actionsPanelLayout_5 = new QVBoxLayout(actionsPanel_5);
        actionsPanelLayout_5->setSpacing(15);
        actionsPanelLayout_5->setObjectName("actionsPanelLayout_5");
        lblActions_5 = new QLabel(actionsPanel_5);
        lblActions_5->setObjectName("lblActions_5");
        lblActions_5->setStyleSheet(QString::fromUtf8("QLabel {\n"
"    font-size: 16px;\n"
"    font-weight: 600;\n"
"    color: #ffffff;\n"
"    background: transparent;\n"
...
"}"));
        ...
        actionsPanelLayout_5->addWidget(lblActions_5);

        btnEditCustomer = new QPushButton(actionsPanel_5);
        btnEditCustomer->setObjectName("btnEditCustomer");
        btnEditCustomer->setMinimumSize(QSize(0, 45));
        btnEditCustomer->setStyleSheet(QString::fromUtf8("QPushButton {\n"
"    background-color: transparent;\n"
"    border: 1px solid #00ff9c;\n"
"    border-radius: 8px;\n"
"    padding: 12px 15px;\n"
...
"}"));
        ...
        actionsPanelLayout_5->addWidget(btnEditCustomer);

        btnDeleteCustomer = new QPushButton(actionsPanel_5);
        btnDeleteCustomer->setObjectName("btnDeleteCustomer");
        btnDeleteCustomer->setMinimumSize(QSize(0, 45));
        btnDeleteCustomer->setStyleSheet(QString::fromUtf8("QPushButton {\n"
"    background-color: transparent;\n"
"    border: 1px solid #ff6666;\n"
"    border-radius: 8px;\n"
"    padding: 12px 15px;\n"
...
"}"));
        ...
        actionsPanelLayout_5->addWidget(btnDeleteCustomer);

        btnReportStatus = new QPushButton(actionsPanel_5);
        btnReportStatus->setObjectName("btnReportStatus");
        btnReportStatus->setMinimumSize(QSize(0, 45));
        btnReportStatus->setStyleSheet(QString::fromUtf8("QPushButton {\n"
"    background-color: transparent;\n"
"    border: 1px solid #00ff9c;\n"
"    border-radius: 8px;\n"
"    padding: 12px 15px;\n"
...
"}"));
        ...
        actionsPanelLayout_5->addWidget(btnReportStatus);

        btnClearSelection_5 = new QPushButton(actionsPanel_5);
        btnClearSelection_5->setObjectName("btnClearSelection_5");
        btnClearSelection_5->setMinimumSize(QSize(0, 45));
        btnClearSelection_5->setStyleSheet(QString::fromUtf8("QPushButton {\n"
"    background-color: transparent;\n"
"    border: 1px solid #00ff9c;\n"
"    border-radius: 8px;\n"
"    padding: 12px 15px;\n"
...
"}"));
        ...
        btnExportPDF_5->setMinimumSize(QSize(0, 45));
        btnExportPDF_5->setStyleSheet(QString::fromUtf8("QPushButton {\n"
"    background-color: #00ff9c;\n"
"    border: 1px solid #00ff9c;\n"
"    border-radius: 8px;\n"
"    padding: 12px 15px;\n"
...
"}"));
        ...
        actionsPanelLayout_5->addWidget(btnExportPDF_5);


        tableActionsLayout_5->addWidget(actionsPanel_5);


        mainContentLayout_5->addLayout(tableActionsLayout_5);
        ...
        sidebarLogo_7 = new QLabel(sidebarGroup_2);
        sidebarLogo_7->setObjectName("sidebarLogo_7");
        sidebarLogo_7->setMinimumSize(QSize(0, 100));
        sidebarLogo_7->setMaximumSize(QSize(16777215, 100));
        sidebarLogo_7->setPixmap(QPixmap(QString::fromUtf8(":/image/images/logo.png")));
        sidebarLogo_7->setScaledContents(false);
        sidebarLogo_7->setAlignment(Qt::AlignmentFlag::AlignCenter);

        sidebarLayout_2->addWidget(sidebarLogo_7);
...
"}"));
        ...
        wasteTable->setHorizontalHeaderItem(0, __qtablewidgetitem16);
        QTableWidgetItem *__qtablewidgetitem17 = new QTableWidgetItem();
        wasteTable->setHorizontalHeaderItem(1, __qtablewidgetitem17);
        QTableWidgetItem *__qtablewidgetitem18 = new QTableWidgetItem();
        wasteTable->setHorizontalHeaderItem(2, __qtablewidgetitem18);
        QTableWidgetItem *__qtablewidgetitem19 = new QTableWidgetItem();
        wasteTable->setHorizontalHeaderItem(3, __qtablewidgetitem19);
        QTableWidgetItem *__qtablewidgetitem20 = new QTableWidgetItem();
        wasteTable->setHorizontalHeaderItem(4, __qtablewidgetitem20);
        QTableWidgetItem *__qtablewidgetitem21 = new QTableWidgetItem();
        wasteTable->setHorizontalHeaderItem(5, __qtablewidgetitem21);
        QTableWidgetItem *__qtablewidgetitem22 = new QTableWidgetItem();
        wasteTable->setHorizontalHeaderItem(6, __qtablewidgetitem22);
        QTableWidgetItem *__qtablewidgetitem23 = new QTableWidgetItem();
        wasteTable->setHorizontalHeaderItem(7, __qtablewidgetitem23);
...
"}"));
        ...
        sidebarLogo_6->setPixmap(QPixmap(QString::fromUtf8(":/image/images/logo.png")));
...
"}"));
        ...
        vehiclesTable->setHorizontalHeaderItem(0, __qtablewidgetitem24);
        QTableWidgetItem *__qtablewidgetitem25 = new QTableWidgetItem();
        vehiclesTable->setHorizontalHeaderItem(1, __qtablewidgetitem25);
        QTableWidgetItem *__qtablewidgetitem26 = new QTableWidgetItem();
        vehiclesTable->setHorizontalHeaderItem(2, __qtablewidgetitem26);
        QTableWidgetItem *__qtablewidgetitem27 = new QTableWidgetItem();
        vehiclesTable->setHorizontalHeaderItem(3, __qtablewidgetitem27);
        QTableWidgetItem *__qtablewidgetitem28 = new QTableWidgetItem();
        vehiclesTable->setHorizontalHeaderItem(4, __qtablewidgetitem28);
        QTableWidgetItem *__qtablewidgetitem29 = new QTableWidgetItem();
        vehiclesTable->setHorizontalHeaderItem(5, __qtablewidgetitem29);
...
"}"));
        ...
        machinesTable->setHorizontalHeaderItem(0, __qtablewidgetitem30);
        QTableWidgetItem *__qtablewidgetitem31 = new QTableWidgetItem();
        machinesTable->setHorizontalHeaderItem(1, __qtablewidgetitem31);
        QTableWidgetItem *__qtablewidgetitem32 = new QTableWidgetItem();
        machinesTable->setHorizontalHeaderItem(2, __qtablewidgetitem32);
        QTableWidgetItem *__qtablewidgetitem33 = new QTableWidgetItem();
        machinesTable->setHorizontalHeaderItem(3, __qtablewidgetitem33);
        QTableWidgetItem *__qtablewidgetitem34 = new QTableWidgetItem();
        machinesTable->setHorizontalHeaderItem(4, __qtablewidgetitem34);
        QTableWidgetItem *__qtablewidgetitem35 = new QTableWidgetItem();
        machinesTable->setHorizontalHeaderItem(5, __qtablewidgetitem35);
...
"}"));
        ...
        sidebarLogo_5 = new QLabel(sidebarGroup_4);
        sidebarLogo_5->setObjectName("sidebarLogo_5");
        sidebarLogo_5->setMinimumSize(QSize(0, 100));
        sidebarLogo_5->setMaximumSize(QSize(16777215, 100));
        sidebarLogo_5->setPixmap(QPixmap(QString::fromUtf8(":/image/images/logo.png")));
        sidebarLogo_5->setScaledContents(false);
        sidebarLogo_5->setAlignment(Qt::AlignmentFlag::AlignCenter);

        sidebarLayout_4->addWidget(sidebarLogo_5);
...
"}"));
        ...
        sidebarGroup_5->setGeometry(QRect(0, -3, 250, 721));
...
"}"));
        ...
        mainContentWidget_4->setGeometry(QRect(250, 0, 1107, 711));
        ...
        pageTitle_5 = new QLabel(mainContentWidget_4);
        pageTitle_5->setObjectName("pageTitle_5");
        pageTitle_5->setStyleSheet(QString::fromUtf8("QLabel {\n"
"    font-size: 28px;\n"
"    font-weight: 700;\n"
"    color: #ffffff;\n"
"    background: transparent;\n"
...
"}"));
        ...
        titleLayout_4->addWidget(pageTitle_5);
...
"}"));
        ...
        suppliersTable->setHorizontalHeaderItem(0, __qtablewidgetitem36);
        QTableWidgetItem *__qtablewidgetitem37 = new QTableWidgetItem();
        suppliersTable->setHorizontalHeaderItem(1, __qtablewidgetitem37);
        QTableWidgetItem *__qtablewidgetitem38 = new QTableWidgetItem();
        suppliersTable->setHorizontalHeaderItem(2, __qtablewidgetitem38);
        QTableWidgetItem *__qtablewidgetitem39 = new QTableWidgetItem();
        suppliersTable->setHorizontalHeaderItem(3, __qtablewidgetitem39);
        QTableWidgetItem *__qtablewidgetitem40 = new QTableWidgetItem();
        suppliersTable->setHorizontalHeaderItem(4, __qtablewidgetitem40);
        QTableWidgetItem *__qtablewidgetitem41 = new QTableWidgetItem();
        suppliersTable->setHorizontalHeaderItem(5, __qtablewidgetitem41);
        QTableWidgetItem *__qtablewidgetitem42 = new QTableWidgetItem();
        suppliersTable->setHorizontalHeaderItem(6, __qtablewidgetitem42);
        QTableWidgetItem *__qtablewidgetitem43 = new QTableWidgetItem();
        suppliersTable->setHorizontalHeaderItem(7, __qtablewidgetitem43);
...
"}"));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        sidebarGroup_6->setTitle(QString());
        sidebarLogo_9->setText(QString());
        btnDashboard_5->setText(QCoreApplication::translate("MainWindow", "Dashboard", nullptr));
        btnEmployee_4->setText(QCoreApplication::translate("MainWindow", "Employee Management", nullptr));
        btnCustomer_3->setText(QCoreApplication::translate("MainWindow", "Customer Management", nullptr));
        btnWaste_4->setText(QCoreApplication::translate("MainWindow", "Waste Management", nullptr));
        btnVehicle_4->setText(QCoreApplication::translate("MainWindow", "Vehicle Management", nullptr));
        btnMachines_5->setText(QCoreApplication::translate("MainWindow", "Machines Management", nullptr));
        btnSupplier_3->setText(QCoreApplication::translate("MainWindow", "Supplier Management", nullptr));
        btnLogout_5->setText(QCoreApplication::translate("MainWindow", "Log Out \360\237\232\252", nullptr));
        pageTitle_4->setText(QCoreApplication::translate("MainWindow", "Customers", nullptr));
        ...
        QTableWidgetItem *___qtablewidgetitem7 = customersTable->horizontalHeaderItem(0);
        ___qtablewidgetitem7->setText(QCoreApplication::translate("MainWindow", "ID", nullptr));
        QTableWidgetItem *___qtablewidgetitem8 = customersTable->horizontalHeaderItem(1);
        ___qtablewidgetitem8->setText(QCoreApplication::translate("MainWindow", "Name", nullptr));
        QTableWidgetItem *___qtablewidgetitem9 = customersTable->horizontalHeaderItem(2);
        ___qtablewidgetitem9->setText(QCoreApplication::translate("MainWindow", "Email", nullptr));
        QTableWidgetItem *___qtablewidgetitem10 = customersTable->horizontalHeaderItem(3);
        ___qtablewidgetitem10->setText(QCoreApplication::translate("MainWindow", "Phone", nullptr));
        QTableWidgetItem *___qtablewidgetitem11 = customersTable->horizontalHeaderItem(4);
        ...
        ___qtablewidgetitem14->setText(QCoreApplication::translate("MainWindow", "Emplyee_ID", nullptr));
        ...
        btnReportStatus->setText(QCoreApplication::translate("MainWindow", "Report Status", nullptr));
        btnClearSelection_5->setText(QCoreApplication::translate("MainWindow", "Clear", nullptr));
        btnExportPDF_5->setText(QCoreApplication::translate("MainWindow", "Export PDF", nullptr));
        sidebarGroup_2->setTitle(QString());
        sidebarLogo_7->setText(QString());
        ...
        pageTitle_5->setText(QCoreApplication::translate("MainWindow", "Supplier Management", nullptr));
